...
void StatisticsForm::makeChart()
{
 ...
 //   chartView = new QChartView(createSplineChart());
    chartView = new QChartView(createSimpleBarChart());
...
void StatisticsForm::showEvent(QShowEvent *event)
{
    m_dataTable = generateRandomData(m_listCount, m_valueMax, m_valueCount);
    makeChart();
}
...
QChart *StatisticsForm::createSimpleBarChart() const
{
    //![1]
