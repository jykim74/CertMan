...
CMPSrvDlg::CMPSrvDlg(QWidget *parent) :
    QDialog(parent)
{
    setupUi(this);
...
void CMPSrvDlg::loadTable()
{
    ...
    dbMgr->getConfigList( JS_GEN_KIND_CMP_SRV, configList );
...
void CMPSrvDlg::clickAdd()
{
    ...
    config.setKind( JS_GEN_KIND_CMP_SRV );
...
void CMPSrvDlg::clickFindServer()
{
...
void CMPSrvDlg::clickCheck()
{

}

void CMPSrvDlg::clickStart()
{
...
void CMPSrvDlg::slotConfigMenuRequested(QPoint pos)
{
...
void CMPSrvDlg::deleteConfigMenu()
{
