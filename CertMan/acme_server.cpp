...
int ACMEServer::readReady()
{
    ...
    else if( path_.contains( "/EST" ) == true )
    {
        ...
        if( binRsp.nLen > 0 )
        {
            ...
            log( QString( "Rsp: %1").arg( rsp.data() ));
            client_->write( "\r\n" );
            client_->write( rsp );
        }
...
int ACMEServer::getChainList( BINList **ppChainList )
{
    CertRec caRec;
    DBMgr* dbMgr = manApplet->dbMgr();
    BIN binCert = {0,0};
...
int ACMEServer::runACME_Finalize( ACMEObject& acmeObj, QJsonObject& rspJson )
{
    /*
    {
        "status": "processing",
...
int ACMEServer::runACME_Account( ACMEObject& acmeObj, const QString strKID, QJsonObject& rspJson )
{
    int ret = 0;
    ACMEStat stat;
    BIN binPub = {0,0};
...
int ACMEServer::runACME_Certificate( ACMEObject& acmeObj, BINList **ppCertList )
{
    /*
    -----BEGIN CERTIFICATE-----
...
int ACMEServer::runACME_Order( ACMEObject& acmeObj, const QString strKID, QJsonObject& rspJson )
{
    /*
    {
        ...
        "profile": "shortlived",
        "finalize": "https://localhost:14000/finalize-order/NRNjqH9w3k4vmqPFq-ZnmF7iknL3lhMENnhetj76V4I",
        "authorizations": [
            "https://localhost:14000/authZ/0EWyarULx56YoG9fZbimsurLuVmrpIMuQ4TbbpGAmaQ"
        ],
        "certificate": "https://localhost:14000/aaaabbb"
    }
    */
...
int ACMEServer::runACME_Orders( ACMEObject& acmeObj, const QString strKID, QJsonObject& rspJson )
{
    ...
    {
        "orders": [
            "https://localhost:14000/my-order/5kquX4gxPgEuymyknKHtHsDzTvnuAyp2Py5NzhxSrQY",
            "https://localhost:14000/my-order/Rl-ZcIKS6_CD3DX0_VecZ6ySUdTyU3chWjlNIZPLPKw"
        ]
    }
    */
